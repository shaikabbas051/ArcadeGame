...
Player.prototype.update = function(dt) {
    if (this.y <= 0) {
        this.x = 200;
        this.y = 380; // return to the initial position when reached the final row
...
//input
var allEnemies = [new Enemy(0, 60, 100), new Enemy(0, 145, 80), new Enemy(0, 230, 50)];
